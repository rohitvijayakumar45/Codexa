...
Source: https://github.com/vercel-labs/web-interface-guidelines (fetched 2026-09-06, verbatim).

Review UI code against the rules below. Output concise but comprehensive — sacrifice grammar for
brevity. High signal-to-noise.
